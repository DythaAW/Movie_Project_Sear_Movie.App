package com.example.movieproject.helper;
...
import static com.example.movieproject.database.DatabaseContract.FavoriteColumns.DESCRIPTION;
import static com.example.movieproject.database.DatabaseContract.FavoriteColumns.POSTER;
import static com.example.movieproject.database.DatabaseContract.FavoriteColumns.RELEASE_DATE;
import static com.example.movieproject.database.DatabaseContract.FavoriteColumns.TITLE;
import static com.example.movieproject.database.DatabaseContract.TABLE_MOVIE;
...
public class FavoriteHelper {
    ...
    public long insert(FavoriteModel note){

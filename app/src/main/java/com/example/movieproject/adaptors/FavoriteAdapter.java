package com.example.movieproject.adaptors;
...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.ViewHolder> {
    private LinkedList<FavoriteModel> listFavorites;
    ...
    public LinkedList<FavoriteModel> getListFavorite() {
        return listFavorites;
    }

    public void setListFavorite(LinkedList<FavoriteModel> listFavorites) {
